...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Repositories",
          description: "Repositories of note",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/sarthakpati.bsky.social", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/sarthakpati", "_blank");
        },
      },{
        id: 'social-ieee',
        title: 'IEEE Xplore',
        section: 'Socials',
        handler: () => {
          window.open("https://ieeexplore.ieee.org/author/37594669000/", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/sarthakpati", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-2243-8487", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=lL5jPysAAAAJ", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
